      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
            {translations.expertiseTitle}
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {translations.expertiseSubtitle}
          </p>
        </div>
        ...
        <div className="bg-emerald-50 rounded-2xl p-8 md:p-12 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-800 mb-2">{translations.authentic}</h4>
              <p className="text-gray-600">{translations.authenticDesc}</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-800 mb-2">{translations.provenResults}</h4>
              <p className="text-gray-600">{translations.provenResultsDesc}</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-800 mb-2">{translations.support247}</h4>
              <p className="text-gray-600">{translations.support247Desc}</p>
            </div>
          </div>
        </div>
      </div>
