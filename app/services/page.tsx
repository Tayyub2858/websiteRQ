...
export default function ServicesPage() {
  ...
  const handleEmailPopupOpen = () => {
    try {
      ...
      console.error('Error opening email popup:', err);
      setError('Failed to open email popup. Please try again.');
    }
  };
  ...
  const handleEmailPopupClose = () => {
    try {
      ...
      console.error('Error closing email popup:', err);
    }
  };
  ...
  return (
    <>
      <div className="min-h-screen">
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Service",
              "name": "Islamic Spiritual Healing Services - Expert Quranic Treatment and Spiritual Guidance",
              "description": " World's leading Islamic spiritual healing services including expert Quranic treatment, Istikhara consultation, black magic removal, evil eye protection, marriage solutions, anxiety and depression treatment, family problem solutions, business success guidance, health and wellness healing, and comprehensive spiritual guidance based on Holy Quran and Sunnah. Serving clients worldwide in 15+ countries with 98% success rate and 10,000+ satisfied clients.",
              "url": "https://rehmatequran.com/services",
              ...
              "serviceType": "Islamic Spiritual Healing and Quranic Treatment",
              "areaServed": [
                "Pakistan", "UAE", "Saudi Arabia", "Kuwait", "Qatar", "USA", "Australia", "UK", "Germany", "France", "Italy", "Spain", "Netherlands", "Malaysia", "Turkey"
              ],
              "availableLanguage": ["English", "Urdu", "Arabic", "Malay", "Turkish"],
              "hasOfferCatalog": {
                "@type": "OfferCatalog",
                "name": "Comprehensive Islamic Spiritual Healing Services",
                "itemListElement": [
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "description": "Professional Istikhara consultation for marriage, business, career, health, and important life decisions. Expert Islamic spiritual guidance through authentic prayer and divine consultation based on Holy Quran and Sunnah. Available in multiple languages for worldwide clients.",
                      "serviceType": "Spiritual Consultation and Divine Guidance",
                      "category": "Islamic Spiritual Services",
                      "url": "https://rehmatequran.com/services/istikhara"
                    }
                  },
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "serviceType": "Spiritual Protection and Cleansing",
                      "category": "Islamic Spiritual Protection",
                      "url": "https://rehmatequran.com/services/black-magic-removal"
                    }
                  },
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "serviceType": "Relationship Counseling and Marriage Therapy",
                      "category": "Islamic Marriage Counseling",
                      "url": "https://rehmatequran.com/services/marriage-solutions"
                    }
                  },
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "serviceType": "Mental Health Treatment and Psychological Therapy",
                      "category": "Islamic Mental Health Services",
                      "url": "https://rehmatequran.com/services/anxiety-depression-treatment"
                    }
                  },
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "serviceType": "Family Counseling and Mediation",
                      "category": "Islamic Family Services",
                      "url": "https://rehmatequran.com/services/family-problem-solutions"
                    }
                  },
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "serviceType": "Business Consultation and Financial Guidance",
                      "category": "Islamic Business Services",
                      "url": "https://rehmatequran.com/services/business-success-guidance"
                    }
                  },
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "serviceType": "Health and Wellness Treatment",
                      "category": "Islamic Health Services",
                      "url": "https://rehmatequran.com/services/health-wellness-treatment"
                    }
                  },
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "serviceType": "Spiritual Healing and Energy Cleansing",
                      "category": "Islamic Spiritual Healing",
                      "url": "https://rehmatequran.com/services/spiritual-blockage-removal"
                    }
                  }
                ]
              },
              ...
              "availableChannel": [
                "Phone", "Email", "WhatsApp", "Online Consultation", "Video Call"
              ]
            })
          }}
        />
        ...
        <ServicesHero translations={t} />
        <ServicesList translations={t} />
        <ServiceProcess translations={t} />
        <ContactCTA translations={t} />
